...
//lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 2000, 10, locationListener);
    ...
    public void startRestaurants() {
        ...
        {
            Intent intent = new Intent(this, DisplayShops.class);
            LocationManager lm = (LocationManager)getSystemService(Context.LOCATION_SERVICE);
    ...
    public void showRestaurants(){
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            Snackbar.make(mLayout,
                    "Location permission available. Show shops.",
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == PERMISSION_REQUEST_LOCATION) {
            ...
            if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Snackbar.make(mLayout, "Location permission granted. Showing shops.",
    ...
    private void requestLocationPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(mLayout, "Location access is required to display shops near you.",
