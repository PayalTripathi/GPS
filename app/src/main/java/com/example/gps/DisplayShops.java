...
public class DisplayShops extends AppCompatActivity {
    ...
    private static final String API_KEY = "AIzaSyDbcv-DDAqJrXSzrpk9ekRDQlQv6JuAOz8";

    private static final String PLACES_API_BASE = "https://maps.googleapis.com/maps/api/place/nearbysearch/output?parameters";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_shops);
